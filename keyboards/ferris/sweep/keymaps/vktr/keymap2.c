...
#define KC_ENTM1 LT(1, KC_ENT)
#define KC_GUTA GUI_T(KC_TAB)
#define KC_ALGV LALT_T(KC_GRV)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( /* QWERTY */
    ...
    KC_LSHZ,  	  KC_X,    KC_C,    KC_V,    KC_B,            KC_N,    KC_M,  KC_COMM, KC_DOT, KC_RLSH,
                                    KC_ALGV, KC_SPM2,   `KC_ENTM1, KC_GUTA
  ),
  ...
  [_RAISE] = LAYOUT( /* [> RAISE <] */
    ...
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,         KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_PIPE,
    KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,        KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TRNS,
                                    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  )
};
